          ...
          <div className="content">
            ...
            <div className="questions">
              <div className="Q1">
                ...
                <ul>
                  <li>
                    <p>Max left his rubbish on the table.</p>
                    <input
                      type="radio"
                      name="q1"
                      value="0"
                  ...
                  <li>
                    <p> The ice skating rink was closed.</p>
                    <input
                      type="radio"
                      name="q1"
                      value="1"
                  ...
                  <li>
                    <p> Cole left his skates at home.</p>
                    <input
                      type="radio"
                      name="q1"
                      value="2"
              ...
              <div className="Q3">
                ...
                <ul>
                  ...
                  <li>
                    <p> He put his rubbish in the bin.</p>
                    <input
                      type="radio"
                      name="q3"
                      value="1"
