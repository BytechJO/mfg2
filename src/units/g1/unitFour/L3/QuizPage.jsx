...
export const QuizPage = () => {
  ...
  const handleSubmit = () => {
    ...
    setShowSkip(true);
    setshowtry(true);
    const score = Object.values(newResults).filter(
      (isCorrect) => isCorrect
    ).length;
            ...
            <div className="questions">
              <div className="Q1">
                ...
                <ul>
                  ...
                  <li>
                    <p> She wanted to play outside.</p>
                    <input
                      type="radio"
                      name="q1"
                      value="2"
              ...
              <div className="Q2">
                ...
                <ul>
                  ...
                  <li>
                    <p> She wanted to eat all her yummy food.</p>
                    <input
                      type="radio"
                      name="q2"
                      value="1"
              ...
              <div className="Q3">
                ...
                <ul>
                  ...
                  <li>
                    <p> She helped Ella with her homework.</p>
                    <input
                      type="radio"
                      name="q3"
                      value="1"
                  ...
                  <li>
                    <p> She shared her lunch with Ella.</p>
                    <input
                      type="radio"
                      name="q3"
                      value="2"
