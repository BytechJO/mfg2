          ...
          <div className="content quizfix">
            <div className="questions">
              ...
              <div className="Q2">
                ...
                <ul>
                  <li>
                    <p> She wanted to eat the cookies. </p>
                    <input
                      type="radio"
                      name="q2"
                      value="0"
                  ...
                  <li>
                    <p> She wanted to bake cookies for her friend. </p>
                    <input
                      type="radio"
                      name="q2"
                      value="2"
              ...
              <div className="Q3">
                ...
                <ul>
                  <li>
                    <p> They took them to the park.</p>
                    <input
                      type="radio"
                      name="q3"
                      value="0"
                  ...
                  <li>
                    <p> They baked cookies for them.</p>
                    <input
                      type="radio"
                      name="q3"
                      value="1"
