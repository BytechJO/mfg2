...
export default function UnitsPage() {
  ...
  return (
    <div className="max-h-full w-full flex flex-col items-center justify-center p-4 sm:p-20 relative ">
      ...
      <div
        ref={menuRef}
        className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 max-w-4xl w-full relative z-10"
      >
        {units.map((unit) => (
          <motion.div
            key={unit.id}
          ...
          >
            <div
              className="w-14 h-14 sm:w-20 sm:h-20 rounded-2xl flex items-center justify-center text-white shadow-md"
                ...
                {lessons.map((lesson) => (
                  ...
                  >
                    <button
                      ...
                      className={`w-full py-3 px-4 rounded-xl text-left flex justify-between items-center transition-all duration-300 ${
                          ...
                          return (
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                navigate(
                                  `/unit/${unit.unitName}/lesson/${lesson.id}/${content.path}`
                                );
                              }}
